...
@Configuration
@MapperScan(value = "com.ssafy.web.member.sec.mapper", sqlSessionFactoryRef="tripSecSqlSessionFactory")
public class TripSecDatabaseConfig {
	...
	public SqlSessionFactory tripSecSessionFactory(@Qualifier("tripSecDataSource") DataSource db1DataSource, ApplicationContext applicationContext) throws Exception{
		...
		sessionFactory.setMapperLocations(applicationContext.getResources("classpath:mybatis/secmappers/sec.xml")); //쿼리작성용 mapper.xml위치 설정.
