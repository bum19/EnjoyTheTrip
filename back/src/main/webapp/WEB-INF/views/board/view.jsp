        ...
        <div class="col-lg-8 col-md-10 col-sm-12">
          ...
          <div class="row">
			...
			<div class="mt-3">
				<ul>
					<c:forEach var="file" items="${article.fileInfos}">
						...
						<li>${file.original_file} <a href="${root}/file/download/${file.save_folder}/${file.original_file}/${file.save_file}">[다운로드]</a>
					</c:forEach>
				</ul>
			</div>
			</c:if>
            ...
            <div class="d-flex justify-content-end">
              ...
              <c:if test="${userinfo.user_id eq article.user_id}">
